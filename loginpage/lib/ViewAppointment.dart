...
class _ViewappointmentState extends State<Viewappointment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: const Color(0xFF0D47A1)),
      body: Container(
        child: Column(
          children: [
            Container(
           ...
           Padding(
             ...
             child: Container(
               ...
               height: 130,
               decoration: BoxDecoration(
                 color: const Color(0xFF0D47A1), // A solid teal shade for the container
                 ...
                 child: ListTile(
                   ...
                   leading: CircleAvatar(
                     ...
                     child: Icon(
                       ...
                       size: 40,
                       color: const Color(0xFF0D47A1), // Matches container theme
                     ),
                   ),
                   title: Text(
                     "Adwaith",
